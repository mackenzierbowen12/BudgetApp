...
var budgetController = (function() {
    ...
    var data = {
        ...
        budget: 0,
        percentage: -1 // if there are no values and budget expenses, the cannot be a percentage, so it doesn't exist
    };
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var updateBudget = function() {
        ...
        // 3. Update the UI to display new budget
    ...
    var ctrlAddItem = function() {
        ...
        //1. click add button, get the filed input data
        input = UICtrl.getInput();
        
        if (input.description !== "" && !isNaN(input.value) && input.value > 0) {
            
            //2. add item to budgt controller
